...
if (args.length < 1 || !isUrl(text) || !xeonaudp3.isYTUrl(text)) throw `Link YouTube Nya Mana?\nContoh: ${prefix + command} https://youtu.be/H0F4Xlof5tg`
...
reply(`•DIMAS BOT DEVELOPER•\n\n\n   ©2021-2023 Bang Dims\n\n🇲🇨\nPm: wa.me/6289603732786`)
}
            break
...
teks = `*「 ${global.botname} 」*\n\nWebsite: ${global.websitex}\nGrup: ${global.botscript}\n\nDana: 089603732786\nPulsa: 082133394459\n\nJangan Lupa Donasi Yah🍜`
let buttons = [
{buttonId: `owner`, buttonText: {displayText: 'Owner 🌺'}, type: 1}
]
let buttonMessage = {
image: {url: `https://telegra.ph/file/c181fd51f402e6e0b68e2.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title:"📌Donasi Supaya Bot Tetap Online 📌",
body: "🔜Klik Untuk Donate🔚", 
thumbnail: fs.readFileSync("XeonMedia/theme/cheemspic.jpg"),
mediaType:1,
mediaUrl: 'https://telegra.ph/file/c181fd51f402e6e0b68e2.jpg',
sourceUrl: "https://telegra.ph/file/c181fd51f402e6e0b68e2.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
"message": ownername,
"orderTitle": wm, // 
"sellerJid": " 6289603732786@s.whatsapp.net",
...
│𝗕𝗼𝘁 𝗔𝗸𝘁𝗶𝗳 : ${runtime(process.uptime())}
...
└┬────────────┈ ⳹
   ...
   └─────────────┈ ⳹`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'Semua Menu' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'sc', buttonText: { displayText: 'Donate' }, type: 1 }]
            let buttonMessage = {
 ...
 break
	...
	const sections = [{
							...
							{
								"title": "Fitur Dimas Botzz️",
								"rows": [
									{
										"title": "All Menu 🥀",
										"description": "Menampilkan Semua Fitur Dimas Botzz",
									...
									{
										"title": "Group Menu ✨",
										"description": "Menu Khusus Untuk Grup",
										"rowId": `${prefix}groupmenu`
										},
										{
										"title": "Maker Menu 🌈",
										"description": "Ayo Membuat Logo Keren Bersama Dimas Botzz",
										"rowId": `${prefix}makermenu`
									},
									{
										"title": "Sound Menu 🎵",
										"description": "Kamu Gabut? Sini Dengerin Musik ",
									...
									{
										"title": "Sticker Menu 🃏",
										"description": "Mau Buat Stiker Kak?",
										"rowId": `${prefix}stickermenu`
									},
									{
										"title": "Search Menu 🔎",
										"description": "Mau Cari Apa Nih Kak?",
										"rowId": `${prefix}searchmenu`
									},
									{
										"title": "Random Image Menu 🌆",
										"description": "Menampilkan Fitur Foto Random",
										"rowId": `${prefix}randomimagemenu`
									},
									{
										"title": "Random Video Menu 🌆",
										"description": "Menampilkan Fitur Video Random",
										"rowId": `${prefix}randomvideomenu`
									},
									{
										"title": "Image Effect Menu 🖼️",
										"description": "Menampilkan Fitur Efek Khusu Foto",
										"rowId": `${prefix}imageeffectmenu`
									},
										{
											"title": "Anime Menu 😘",
										"description": "Menu Khusus Wibu,Bukan Wibu Dilarang Pake🗿",
										"rowId": `${prefix}animemenu`
										},
										{
											"title": "Emot Menu 😀",
										"description": "Menampilkan Fitur Emot Keren Dan Unik",
										"rowId": `${prefix}emotemenu`
										},
										{
										"title": "Anime Sticker Menu ☺️",
										"description": "Menampilkan Fitur Anime Stiker",
										"rowId": `${prefix}animestickermenu`
									     },
									{
										"title": "Nsfw Menu 🤓",
										"description": "Eey Yo Wtf Area Khusus 18+🔞",
										"rowId": `${prefix}nsfwmenu`
									     },
										{
											"title": "Fun Menu 🕺",
										"description": "Menampilkan Fitur Untuk Seru Seruan",
										...
										"description": "Ingin Convert Sesuatu?",
										...
										{
										"title": "War Menu☣️",
										"description": "Dilarang Pake 🚫",
										"rowId": `${prefix}warmenu`
									}
								]
							},
							{
								"title": "Chat Bersama User Dimas Botzz 🌝",
								"rows": [
									{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To ❤️",
										"description": "Siapa Saja Yg Berkontribusi Di Sistem Ini",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
const listMessage = {
  text: "Silahkan Pilih Menu Di Bawah",
  footer: `${botname}\nWebsite: ${websitex}\nGrup Bot: ${botscript}`,
  title: `Hi 👋 ${pushname}`,
